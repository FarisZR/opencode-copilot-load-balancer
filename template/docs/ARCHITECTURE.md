...
The plugin registers three tools under the `copilot-accounts-` prefix:
- `copilot-accounts-list`: Lists all accounts, their status, and IDs.
- `copilot-accounts-disable`: Disables an account by ID.
- `copilot-accounts-enable`: Enables an account by ID.
